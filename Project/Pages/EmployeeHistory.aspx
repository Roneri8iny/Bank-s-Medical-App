<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Employee.master" AutoEventWireup="true" CodeFile="EmployeeHistory.aspx.cs" Inherits="Pages_History" %>
                        ...
                        <div class="card-body">
                            <div class="list-group">
                                <span class="list-group-item">
                                    <asp:Label ID="Label3" runat="server" Text="Appointment Z" CssClass="mb-1" Style="font-size: 20px; color: #25396f; font-weight: bold; display: block;"></asp:Label>

                                    <asp:Label ID="Label4" runat="server" Text="Date:" CssClass="mb-1" Style="display: block;"></asp:Label>
                                    <asp:Label ID="Label5" runat="server" Text="Doctor:" CssClass="mb-1" Style="display: block;"></asp:Label>
                                    <asp:Label ID="Label1" runat="server" Text="Department:" CssClass="mb-1" Style="display: block;"></asp:Label>
                                    <asp:Label ID="Label6" runat="server" Text="Status: soon..." CssClass="mb-1" Style="display: block;"></asp:Label>
                                    <div class="d-flex w-100 justify-content-end">
                                        <asp:Button ID="RequestButton" runat="server" Text="Cancel" CssClass="btn btn-primary rounded-pill" />
                                    </div>
                                </span>
                                <span class="list-group-item">
                                    <asp:Label ID="Label2" runat="server" Text="Appointment Y" CssClass="mb-1" Style="font-size: 20px; color: #25396f; font-weight: bold; display: block;"></asp:Label>

                                    <asp:Label ID="Label7" runat="server" Text="Date:" CssClass="mb-1" Style="display: block;"></asp:Label>
                                    <asp:Label ID="Label8" runat="server" Text="Doctor:" CssClass="mb-1" Style="display: block;"></asp:Label>
                                    <asp:Label ID="Label9" runat="server" Text="Department:" CssClass="mb-1" Style="display: block;"></asp:Label>
                                    <asp:Label ID="Label10" runat="server" Text="Status: Canceled" CssClass="mb-1" Style="display: block;"></asp:Label>
                                </span>
                                <span class="list-group-item">
